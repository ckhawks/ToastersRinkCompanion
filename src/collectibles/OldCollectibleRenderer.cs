...
//
// public class OldCollectibleRenderer
// {
...
//     private static Dictionary<string, string> oldTexturePaths = new Dictionary<string, string>
//     {
...
//     };
//
//     public class SpawnedCollectibleInfo
//     {
...
//         public OldRarityHelper.Rarity CurrentRarity; // Stored rarity
...
//     private static List<SpawnedCollectibleInfo> activeCollectibles = new List<SpawnedCollectibleInfo>();
//     
...
//     }
//
//     public static GameObject CreateCollectible(CollectibleItem collectible)
//     {
//         return null;
//     }
//     
//     public static void ShowCollectiblePrototype(Player player)
//     {
...
//         List<string> textureKeys = new List<string>(oldTexturePaths.Keys);
//         string randomTextureDisplayName = textureKeys[Random.Range(0, textureKeys.Count)];
//         string randomTextureFileName = oldTexturePaths[randomTextureDisplayName];
//
...
//         OldRarityHelper.Rarity[] allRarities = (OldRarityHelper.Rarity[])System.Enum.GetValues(typeof(OldRarityHelper.Rarity));
//         OldRarityHelper.Rarity assignedRarity = allRarities[Random.Range(0, allRarities.Length)];
//
...
//         SpawnedCollectibleInfo newSpawnedCollectibleInfo = new SpawnedCollectibleInfo 
//         { 
...
//         mainTextComponent.color = OldRarityHelper.GetColor(assignedRarity);
...
//         newSpawnedCollectibleInfo.TextBillboardGameObject = textBillboardRoot;
...
//
//         activeCollectibles.Add(newSpawnedCollectibleInfo);
//     }
//
...
//         }
//         
//         List<SpawnedCollectibleInfo> collectiblesToDespawn = new List<SpawnedCollectibleInfo>();
//
//         foreach (SpawnedCollectibleInfo collectibleInfo in activeCollectibles)
//         {
//             // --- Despawn Logic ---
...
//         }
//
//         foreach (SpawnedCollectibleInfo infoToDespawn in collectiblesToDespawn)
//         {
...
//     }
//
//     private static GameObject LoadPrefab(string collectibleType)
//     {
...
//         {
//             LoadCollectibleAssetBundle();
//             GameObject prefab2 = PrefabHelper.LoadPrefab(_loadedAssetBundle, $"assets/collectibles/models/{CollectiblesConstants.ITEM_PATHS[collectibleType]}");
//             if (prefab2 == null)
//             {
...
//         {
//             LoadCollectibleAssetBundle();
//             Texture2D texture2 = PrefabHelper.LoadTexture2D(_loadedAssetBundle, $"assets/collectibles/skintextures/{CollectiblesConstants.PATTERN_PATHS[textureName]}");
//             if (texture2 == null)
//             {
...
//     }
//     
//     public static void RemoveCollectible(SpawnedCollectibleInfo info)
//     {
